      ...
      <Grid item xs={12} sm={6} >
        <Stack direction={'column'}>
          ...
          <Grid container spacing={1}>
            ...
            <Grid item xs={6}>
              <Typography variant="body2">{projectdetails.start_date.slice(0, 10)}</Typography>
            </Grid>
            {/* <Grid item xs={6}>
          ...
          <Grid item xs={6}>
            ...
            <Grid item xs={6}>
              <Typography variant="body2">{projectdetails.end_date.slice(0, 10)}</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography variant="body2">Swap Rates</Typography>
            </Grid>
            <Grid item xs={6}>
              <Typography variant="body2">{projectdetails.swap_rate}</Typography>
            </Grid>
            <Grid item xs={6}>
